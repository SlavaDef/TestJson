...
public class HttpUtilUser2_0 {

// Одразу створюємо кліента, щоб не створювати в кожному методі
    private static final HttpClient CLIENT = HttpClient.newHttpClient();

    // створили GSON, щоб не створювати в кожному методі
    private static final Gson GSON = new Gson();
    // метод getResponse приймає url, method та BodyPublisher
